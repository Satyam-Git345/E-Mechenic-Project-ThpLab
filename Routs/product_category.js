...
const {getproduct_catbyid,getproduct_cat,postproduct_cat,delete_product_cat,update_product_cat}=require('../Controller/product_category');

route.get('/viewproduct_category',getproduct_cat);
route.get('/viewproduct_categorybyid/:product_cat_id',getproduct_catbyid);
