...
const getshop_byid = async (req, res) => {
  try {
    const data = [req.params.shop_id];
    const qry = "SELECT * FROM tbl_shop WHERE  shop_id=?";
...
const updateshop = async (req, res) => {
  try {
    const data = [
      ...
      req.body.email,
      req.body.website,
      req.body.shop_owner_name,
      req.body.shop_owner_mobile_no,
      req.body.est_year,
      req.body.service_type,
      req.body.other_remark,
      req.body.password,
      req.body.reg_on,
      req.params.shop_id,
    ];
...
module.exports = { getshop, postshop, deleteshop, updateshop, getshop_byid };
